...
//                fullLocationResponse.LocationResponse.mapStrings = enterLocationTextField.text!
//                locationResponse.mediaURLs = enterLinkTextField.text!
            ...
            if let placemarks = placemarks, placemarks.count > 0 {
                ...
                if let location = placemark.location {
                   ...
                   print(coordinate.latitude)
                    ...
                    //old below that didn't work
//                    fullLocationResponse.LocationResponse.latitude = coordinate.latitude
//
//                    fullLocationResponse.LocationResponse.longitude = coordinate.longitude

                    if (placemark.locality != nil && placemark.administrativeArea != nil){
                        fullLocationResponse.LocationResponse.mapStrings = ("\(placemark.locality!),\(placemark.administrativeArea!)")
                    }
                    getUserName()
                    print(parametersAll.StudentLocation.firstName)
